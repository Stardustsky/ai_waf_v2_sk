...
try:
    if sys.platform == 'win32':
        # print path.join(dirname, r'lib\libsvm-win32.dll')
        libsvm = CDLL(path.join(dirname, r'lib\libsvm-win64.dll'))
        print(libsvm)
    elif sys.platform == 'win64':
        libsvm = CDLL(path.join(dirname, r'lib\libsvm-win64.dll'))
    elif sys.platform == 'darwin':
        libsvm = CDLL(path.join(dirname, r'lib/libsvm.so.mac.2'))
    else:
        libsvm = CDLL(path.join(dirname, 'lib/libsvm.so.ubuntu.2'))
except:
